...
const Battle = () => {
  ...
  const [player2, setPlayer2] = useState({}); // battle/NAME
  ...
  return (
    ...
    >
      ...
      <div className={`${styles.flexCenter} flex-col my-7`}>
        ...
        <div className="flex items-center flex-row">
          <ActionButton
            imgUrl={attack}
            handleClick={() => {}}
            restStyle="mr-2 hover:border-yellow-400"
          />
          ...
          <ActionButton
            imgUrl={defense}
            handleClick={() => {}}
            restStyle="ml-6 hover:border-red-600"
          />
        </div>
      </div>
